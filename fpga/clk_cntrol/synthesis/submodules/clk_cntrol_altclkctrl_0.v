//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="Global Clock" DEVICE_FAMILY="Cyclone 10 LP" ENA_REGISTER_MODE="falling edge" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="OFF" clkselect ena inclk outclk
...
module  clk_cntrol_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //clk_cntrol_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clk_cntrol_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    outclk);
...
`endif
    ...
    clk_cntrol_altclkctrl_0_sub  clk_cntrol_altclkctrl_0_sub_component (
                .clkselect (sub_wire2),
                .ena (sub_wire4),
                .inclk (sub_wire6),
                .outclk (sub_wire0));
